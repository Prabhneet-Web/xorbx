...
class NotificationAlertsCard extends StatelessWidget {
  const NotificationAlertsCard({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        children: [
          _itemsSection(
              'A successful login was made on\ndevice. Review your login activity.'),
