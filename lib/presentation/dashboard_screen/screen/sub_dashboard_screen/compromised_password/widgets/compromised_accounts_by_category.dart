...
class CompromisedAccountsByCategory extends StatelessWidget {
  const CompromisedAccountsByCategory({super.key});
      ...
      child: Padding(
        ...
        child: BarChart(
          BarChartData(
            ...
            titlesData: FlTitlesData(
              leftTitles: AxisTitles(
                sideTitles: SideTitles(
                  showTitles: true,
                  reservedSize:
                      scale.getScaledHeight(25), // Scaled reserved size
            ...
            minY: 0,
            maxY: scale
                .getScaledHeight(100), // Adjust maxY to show full bar height
          ),
        ),
      ),
    );
