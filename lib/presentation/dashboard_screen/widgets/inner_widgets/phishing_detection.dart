...
class PhishingDetection extends StatelessWidget {
  const PhishingDetection({super.key});
        ...
        LineChartData(
          ...
          lineBarsData: [
            LineChartBarData(
              isCurved: true,
              spots: [
                FlSpot(0, scale.getScaledHeight(20)),
                FlSpot(1, scale.getScaledHeight(40)),
                FlSpot(1.5, scale.getScaledHeight(60)),
            ...
            LineChartBarData(
              isCurved: true,
              spots: [
                FlSpot(0, scale.getScaledHeight(80)),
                FlSpot(1, scale.getScaledHeight(60)),
                FlSpot(1.5, scale.getScaledHeight(40)),
                FlSpot(2, scale.getScaledHeight(20)),
                FlSpot(3, scale.getScaledHeight(60)),
                FlSpot(3, scale.getScaledHeight(30)),
                FlSpot(4, scale.getScaledHeight(40)),
                FlSpot(5, scale.getScaledHeight(65)),
                FlSpot(6, scale.getScaledHeight(30)),
                FlSpot(7, scale.getScaledHeight(50)),
                FlSpot(7.5, scale.getScaledHeight(70)),
                FlSpot(8, scale.getScaledHeight(40)),
                FlSpot(8.5, scale.getScaledHeight(60)),
                FlSpot(9, scale.getScaledHeight(20)),
              ],
              dotData: const FlDotData(
                show: true,
              ),
            ...
            LineChartBarData(
              ...
              spots: [
                ...
                FlSpot(1, scale.getScaledHeight(15)),
